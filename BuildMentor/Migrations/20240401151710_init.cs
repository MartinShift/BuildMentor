        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructions_Tools_ToolId",
                        column: x => x.ToolId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToolMaintenanceRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToolMaintenanceRecords_Images_DocumentId",
            ...
            migrationBuilder.CreateTable(
                name: "ToolPermissionRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Commment = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToolPermissionRequests", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToolPermissionRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToolPermissionRequests_Tools_ToolId",
                        column: x => x.ToolId,
                        principalTable: "Tools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToolPermissions_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToolPermissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToolPermissions_Tools_ToolId",
                        column: x => x.ToolId,
                        principalTable: "Tools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ToolMaintenanceId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolMaintenanceRecords_DocumentId",
                table: "ToolMaintenanceRecords",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_ToolMaintenanceRecords_ToolId",
                table: "ToolMaintenanceRecords",
                column: "ToolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolPermissionRequests_ToolId",
                table: "ToolPermissionRequests",
                column: "ToolId");

            migrationBuilder.CreateIndex(
                name: "IX_ToolPermissionRequests_UserId",
                table: "ToolPermissionRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ToolPermissions_AdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolPermissions_UserId",
                table: "ToolPermissions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tools_ImageId",
                table: "Tools",
                column: "ImageId");
        }
