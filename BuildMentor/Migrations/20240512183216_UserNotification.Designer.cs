...
namespace BuildMentor.Migrations
{
    ...
    [Migration("20240512183216_UserNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuildMentor.Database.Entities.ActiveMaintenance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ActiveMaintenances");
                });

            modelBuilder.Entity("BuildMentor.Database.Entities.AdminRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BuildMentor.Database.Entities.ExternalResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BuildMentor.Database.Entities.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BuildMentor.Database.Entities.ActiveMaintenance", b =>
                {
                    b.HasOne("BuildMentor.Database.Entities.UserTool", "UserTool")
                        .WithMany()
            ...
            modelBuilder.Entity("BuildMentor.Database.Entities.ExternalResource", b =>
                {
                    b.HasOne("BuildMentor.Database.Entities.Instruction", null)
            ...
            modelBuilder.Entity("BuildMentor.Database.Entities.UserTool", b =>
                {
                    b.HasOne("BuildMentor.Database.Entities.ToolPermission", "Permission")
                        .WithMany()
